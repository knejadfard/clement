...
public:
    ...
    basic_router(std::initializer_list<element_type> routes)
        : routes_{routes}
    {
    }
    ...
    void
    get(std::string const& r, handler_type h)
    {
    ...
    void
    put(std::string const& r, handler_type h)
    {
    ...
    void
    del(std::string const& r, handler_type h)
    {
    ...
    handler_type
    get_handler(route const& r)
    {
        main_logger.debug("Attempting to find a handler for route: "
                + std::string{r});
        ...
        throw std::runtime_error("could not map '" + std::string{r} + "' to any handlers in the router");
    }

    route
    get_route(route const& r)
    {
        ...
        throw std::runtime_error("could not map '" + std::string{r} + "' to any routes in the router");
    }
